#module with functions that draws stuff on screen

import pygame
from variables import *
import os,sys

#when player click or presses the right keys, the "line" will be highlighted
#at least that sthe idea from the tutorial, need to check after confirming
